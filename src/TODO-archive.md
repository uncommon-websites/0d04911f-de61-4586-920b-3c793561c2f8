...
- [x] Generate high-quality hero image showing teen/young adult thriving emotionally
- [x] Update hero section with compelling copy for mental health companion
- [x] Set centered prop to false
- [x] Remove generating prop from Hero component
- [x] Verify copy uses sentence case and matches brand voice
- [x] Update lib/content/index.ts with company metadata
